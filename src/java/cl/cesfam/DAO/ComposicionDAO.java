...
public class ComposicionDAO {
    public static boolean add(cl.cesfam.ENTITY.Composicion a) throws Exception 
     ...
     public static  List<cl.cesfam.ENTITY.Composicion> getList() throws Exception {
            ...
            try {
                List<cl.cesfam.ENTITY.Composicion> lista = (List<cl.cesfam.ENTITY.Composicion>) 
                session.createCriteria(cl.cesfam.ENTITY.Composicion.class).list();
      ...
      public static  boolean update(cl.cesfam.ENTITY.Composicion a) throws Exception {
         ...
         public static List<cl.cesfam.ENTITY.Composicion> getComposicionByIdMedicamento(int id) throws Exception {
            ...
            try {
                session.beginTransaction();
                List<cl.cesfam.ENTITY.Composicion> tmp = (List<cl.cesfam.ENTITY.Composicion>) session.createCriteria(cl.cesfam.ENTITY.Composicion.class).add(Restrictions.eq("idmedicamento", id)).list();
                session.getTransaction().commit();
                session.close();
                return tmp;
            } catch (Exception e) {
