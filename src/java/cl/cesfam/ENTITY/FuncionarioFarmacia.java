...
public class FuncionarioFarmacia  implements java.io.Serializable {
    ...
    public FuncionarioFarmacia(int idFuncionario, String rutFuncionario, String password, String primerNombreFuncionario, String sengundoNombreFuncionario, String apellidoPaternoFuncionario, String apellidoMaternoFuncionario, Set caducars) {
       this.idFuncionario = idFuncionario;
       this.rutFuncionario = rutFuncionario;
       this.password = password;
       this.primerNombreFuncionario = primerNombreFuncionario;
