...
{
    public static boolean add(cl.cesfam.ENTITY.Reserva a) throws Exception 
        {
     ...
     public static  List<cl.cesfam.ENTITY.Reserva> getList() throws Exception {
            Session session = cl.cesfam.DAL.NewHibernateUtil.getSessionFactory().openSession();
            session.beginTransaction();
            try {
                List<cl.cesfam.ENTITY.Reserva> lista = (List<cl.cesfam.ENTITY.Reserva>) session.createCriteria(cl.cesfam.ENTITY.Reserva.class).list();
       ...
       public static  boolean delete(cl.cesfam.ENTITY.Reserva a) throws Exception {
            Session session = cl.cesfam.DAL.NewHibernateUtil.getSessionFactory().openSession();
            session.beginTransaction();
            try {
                session.delete(a);
      ...
      public static  cl.cesfam.ENTITY.Reserva getReservaByid(int id) throws Exception {
            Session session = cl.cesfam.DAL.NewHibernateUtil.getSessionFactory().openSession();
            try {
                session.beginTransaction();
                cl.cesfam.ENTITY.Reserva tmp = (cl.cesfam.ENTITY.Reserva) 
                        session.createCriteria(cl.cesfam.ENTITY.Reserva.class).add(Restrictions.eq("idReserva", id)).uniqueResult();
                session.getTransaction().commit();
                session.close();
                return tmp;
            } catch (Exception e) {
